 ...
 *
 * @author liuchenhui
 * @since 2019-10-24 18:14
 */
@Slf4j
public abstract class XRXSStrUtils {
    ...
    public static Date parseDateTime(String str) {
        DateFormat format = new SimpleDateFormat(Constants.DATE_STRING_FORMAT);
     ...
     *
     * <pre>
     * XRXSStrUtils.split(null, *)         = null
     * XRXSStrUtils.split("", *)           = []
     * XRXSStrUtils.split("a.b.c", '.')    = ["a", "b", "c"]
     * XRXSStrUtils.split("a..b.c", '.')   = ["a", "b", "c"]
     * XRXSStrUtils.split("a:b:c", '.')    = ["a:b:c"]
     * XRXSStrUtils.split("a b c", ' ')    = ["a", "b", "c"]
     * </pre>
     ...
     * XRXSStrUtils.split(null, *)         = null
     * XRXSStrUtils.split("", *)           = []
     * XRXSStrUtils.split("abc def", null) = ["abc", "def"]
     * XRXSStrUtils.split("abc def", " ")  = ["abc", "def"]
     * XRXSStrUtils.split("abc  def", " ") = ["abc", "def"]
     * XRXSStrUtils.split("ab:cd:ef", ":") = ["ab", "cd", "ef"]
     * </pre>
     *
     * @param str            the String to parse, may be null

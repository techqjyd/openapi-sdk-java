 ...
 */
public class PayrollBonusField extends PayrollField {
    ...
    public PayrollBonusField(String id, Integer lifeCycle, Integer taxMode, String name) {
        this.setId(id);

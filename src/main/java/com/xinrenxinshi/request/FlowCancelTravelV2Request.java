...
public class FlowCancelTravelV2Request extends AbstractOpenapiJsonRequest<ApprovalApplyResponse> {
    /**
     * 员工id
     */
    ...
    public FlowCancelTravelV2Request(String accessToken) {
        super(accessToken);
    }
    ...
    public String getBizUrl() {
        return "/v5/workflow/apply/travel/cancel/v2";
    }
}

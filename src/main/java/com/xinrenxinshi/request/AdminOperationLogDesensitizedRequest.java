...
public class AdminOperationLogDesensitizedRequest extends AbstractOpenapiJsonRequest<PageResult<AdminOperationLogResult>> {
    ...
    public AdminOperationLogDesensitizedRequest(String accessToken) {
        super(accessToken);
    }
    ...
    public String getBizUrl() {
        return "/v5/log/admin/operation/list/desensitized";
    }

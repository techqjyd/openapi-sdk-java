 ...
 */
public class LeaveOutApprovalApplyRequest extends AbstractOpenapiJsonRequest<ApprovalApplyResponse> {
    /**
     * employeeId
     */
    ...
    public LeaveOutApprovalApplyRequest(String accessToken) {
        super(accessToken);
    }
    ...
    public String getBizUrl() {
        return "/v5/workflow/apply/leaveout";
    }
}

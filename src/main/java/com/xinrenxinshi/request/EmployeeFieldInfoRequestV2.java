 ...
 */
public class EmployeeFieldInfoRequestV2 extends AbstractOpenapiJsonRequest<List<EmployeeGroupFieldData>> {
    ...
    public EmployeeFieldInfoRequestV2(String accessToken) {
        super(accessToken);
    }
    ...
    public String getBizUrl() {
        return "/v5/employee/group/employee/fields2";
    }
}

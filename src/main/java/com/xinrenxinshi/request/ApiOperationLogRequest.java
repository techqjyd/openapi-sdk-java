...
public class ApiOperationLogRequest extends AbstractOpenapiJsonRequest<PageResult<ApiOperationLogResult>> {
    ...
    public ApiOperationLogRequest(String accessToken) {
        super(accessToken);
    }
    ...
    public String getBizUrl() {
        return "/v5/log/api/operation/list";
    }

 ...
 **/
public class PayrollUpdateIgnoreAbnormalRequest extends AbstractOpenapiJsonRequest<Object> {
    /**
     * 需要更新的员工及工资数据
     */
    private List<EmployeePayroll> employeePayrolls;

    public PayrollUpdateIgnoreAbnormalRequest(String accessToken) {
        super(accessToken);
    }
    ...
    public String getBizUrl() {
        return "/v5/payroll/update/ignore/abnormal";
    }
}

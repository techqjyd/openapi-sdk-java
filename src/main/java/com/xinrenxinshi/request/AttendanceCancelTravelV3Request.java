...
public class AttendanceCancelTravelV3Request extends AbstractOpenapiJsonRequest<Object> {
    /**
     * 员工id
     */
    ...
    public AttendanceCancelTravelV3Request(String accessToken) {
        super(accessToken);
    }
    ...
    public String getBizUrl() {
        return "/v5/attendance/canceltravel/v3";
    }
}

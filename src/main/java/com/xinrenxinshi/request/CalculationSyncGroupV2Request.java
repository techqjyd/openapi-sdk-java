 ...
 * @desc  同步分组数据
 */
public class CalculationSyncGroupV2Request extends AbstractOpenapiJsonRequest<CalculationSyncGroupDataResponse> {
    ...
    public CalculationSyncGroupV2Request(String accessToken) {
        super(accessToken);
    }

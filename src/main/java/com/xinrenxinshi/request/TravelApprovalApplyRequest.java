 ...
 */
public class TravelApprovalApplyRequest extends AbstractOpenapiJsonRequest<ApprovalApplyResponse> {
    ...
    public TravelApprovalApplyRequest(String accessToken) {
        super(accessToken);
    }
    ...
    public String getBizUrl() {
        return "/v5/workflow/apply/travel";
    }
}

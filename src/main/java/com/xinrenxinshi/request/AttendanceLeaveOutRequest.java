 ...
 */
public class AttendanceLeaveOutRequest extends AbstractOpenapiJsonRequest<AttendanceLeaveOutResponse> {
    /**
     * employeeId
     */
    ...
    public AttendanceLeaveOutRequest(String accessToken) {
        super(accessToken);
    }
    ...
    @Override
    public OpenapiResponse<AttendanceLeaveOutResponse> getResponseClass() {
        return new OpenapiResponse<>();
    }

    @Override
    public TypeReference<OpenapiResponse<AttendanceLeaveOutResponse>> getResponseTypeRef() {
        return new TypeReference<OpenapiResponse<AttendanceLeaveOutResponse>>() {
        };
    }
